...
with open('../../generated_events.txt', 'w') as f:
    for event in generated_events:
        f.write(f"[event_type]: {event.get('type', 'N/A')}\n")
        ...
        if additional_entity_type != "N/A":
            f.write(f"[additional_entity_type]: {additional_entity_type}\n")
            f.write(f"[additional_entity]: {event.get('additional_entity', 'N/A')}\n")
        f.write("=====\n")
